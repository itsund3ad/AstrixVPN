...
# PyInstaller spec for astrix-client.
# Build:  pyinstaller astrix-client.spec
#
...
# SPECPATH is set by PyInstaller when executing the spec
...
a = Analysis(
    ...
    binaries=[],
    datas=[
        (str(ROOT.parent / "client_config.example.json"), "."),
    ],
    hiddenimports=[
